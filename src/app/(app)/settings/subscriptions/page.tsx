...
const PLANS = [
  {
    ...
    features: ['1 outlet', '50 transaksi/bulan', 'Laporan dasar', 'Support email'],
  },
  {
    value: 'warung',
    label: 'Warung',
    ...
    popular: true,
    features: ['1 outlet', 'Transaksi tidak terbatas', 'Laporan lengkap', 'Install PWA', 'Support prioritas'],
  },
  {
    value: 'starter',
    label: 'Starter',
    ...
    features: ['3 outlet', 'Transaksi tidak terbatas', 'Multi kasir', 'Export CSV/PDF', 'Support chat'],
  },
  {
    value: 'professional',
    label: 'Professional',
    ...
    features: ['10 outlet', 'Semua fitur Starter', 'Manajemen promo', 'Analitik advanced', 'Dedicated support'],
  },
  {
    value: 'business',
    label: 'Business',
    ...
    features: ['Outlet tidak terbatas', 'Semua fitur Pro', 'API access', 'Custom integrasi', 'SLA 99.9%'],
  },
  {
    value: 'enterprise',
    label: 'Enterprise',
    ...
    features: ['Semua fitur Business', 'White-label', 'On-premise option', 'Training tim', 'Custom SLA'],
  },
] as const
